package com.greencross.lims.worker.gh.impl;
...
@Service("GHP ver.1.0.0")
public class Ghp_1_0_0 implements Worker {
	private static final Pattern FILE_NAME_PATTERN = Pattern.compile("^((\\d{2}GHP\\d{1,4})[-_](\\d{1,4})[-_](\\d{8}-\\d{3}-\\d{4})).GH.v1.0.0.txt$");
