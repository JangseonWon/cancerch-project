...
public class CreateBatchDialog {
    ...
    public CreateBatchDialog(String worklistId) {
        ...
        iptBatchNames.add(ListElement.singleLine().label("AVD")).add(ListElement.singleLine().label("AVD-A")).add(ListElement.singleLine().label("AIC-A")).add(ListElement.singleLine().label("AIC-B"));
