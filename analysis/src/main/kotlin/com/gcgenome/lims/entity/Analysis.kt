...
data class Analysis(
    ...
    @Column("chrx_cnt")                     val chrXCnt:                Long = 0,
    @Column("chry_cnt")                     val chrYCnt:                Long = 0,
    @Column("chrx_prop")                    val chrXProp:               Double = 0.0,
    @Column("chry_prop")                    val chrYProp:               Double = 0.0,
    @Column("pred_sex")                     val predSex:                String = "?",
    ...
    @Column("chrx_cnt_tmp")                 val chrXCntTmp:             Long = 0,
    @Column("chry_cnt_tmp")                 val chrYCntTmp:             Long = 0,
    @Column("chrx_prop_tmp")                val chrXPropTmp:            Double = 0.0,
    @Column("chry_prop_tmp")                val chrYPropTmp:            Double = 0.0,
    @Column("pred_sex_tmp")                 val predSexTmp:             String = "?",
