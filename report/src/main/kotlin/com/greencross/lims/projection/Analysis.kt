...
data class Analysis (
    ...
    companion object {
        data class AnalysisBuilder(
            ...
            fun build() = Analysis(sample, service, dateRequest, dateSampling, dateDue, sampleType, Patient(patient, patientName, sex, birth, customerName, mrn), barcode, result, too5Pred, too6Pred)
        }
    }
}