...
class SectionTrackingGraph(private val y: Float = 480f) : Painter<DNACTTemplate<DNACTResource>, DNACTDto> {
    override fun paint(
        ...
        stream.paragraph(35f, y-20f, 600f, AlignHorizontal.LEFT, TextBlock(template.resource().styleContentBold().clone().color(Color(0,80,109)).fontSize(15f), "Tracking Graph"))
