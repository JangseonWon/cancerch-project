...
class SectionClinicalInformation(private val y: Float = 625f): Painter<DNACTTemplate<DNACTResource>, DNACTDto> {
    override fun paint(
        ...
        stream.paragraph(112f, y-14f, 400f, AlignHorizontal.LEFT, TextBlock(template.resource().styleContentRegualar().clone().color(Color(0,0,0)).fontSize(15f), dto.result[0].cancer))
