...
class SectionLimitation2(private var y: Float = 755f) : Painter<CancerchTemplate<CancerchResource>, CancerchDto> {
    override fun paint(
        ...
        for(i in 0..5){
            ...
            when (i) {
                0 -> stream.paragraph(56f, y, 600f, AlignHorizontal.LEFT, TextBlock(template.resource().styleContentRegualar().clone().color(Color(0,0,0)).fontSize(7f), "This test screens for cancer by analyzing patterns in cfDNA, and a cancer signal does not indicate a diagnosis of cancer."))
                1 -> stream.paragraph(56f, y, 600f, AlignHorizontal.LEFT, TextBlock(template.resource().styleContentRegualar().clone().color(Color(0,0,0)).fontSize(7f), "This test cannot detect all types of cancer and the test performance may differ depending on the stage or type of cancer."))
                2 -> stream.paragraph(56f, y, 600f, AlignHorizontal.LEFT, TextBlock(template.resource().styleContentRegualar().clone().color(Color(0,0,0)).fontSize(7f), "This test is developed using Lung, Colon, Liver, Pancreatobiliary, Esophageal, and Ovarian cancer sample data. Other cancer types cannot be analyzed accurately."))
                3 -> stream.paragraph(56f, y, 600f, AlignHorizontal.LEFT, TextBlock(template.resource().styleContentRegualar().clone().color(Color(0,0,0)).fontSize(7f), "The sensitivity may vary depending on the location and genetic characteristics of the cancer."))
                4 -> stream.paragraph(56f, y, 600f, AlignHorizontal.LEFT, TextBlock(template.resource().styleContentRegualar().clone().color(Color(0,0,0)).fontSize(7f), "The test performance and tested cancer type can be modified according to the ML-algorithm improvement."))
                5 -> stream.paragraph(56f, y, 600f, AlignHorizontal.LEFT, TextBlock(template.resource().styleContentRegualar().clone().color(Color(0,0,0)).fontSize(7f), "This test may be reported as false positive in the examinee with benign diseases, autoimmune diseases, etc., and may be reported as false negative in case of\n" +
        ...
        stream.paragraph(188f, y+102, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, "96.5%"))
        stream.paragraph(293f, y+102, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, "81.1%"))
        stream.paragraph(392f, y+102, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, "74.4%"))
        stream.paragraph(498f, y+102, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, "97.6%"))

        stream.paragraph( 88f, y+86, 100f, AlignHorizontal.CENTER, TextBlock(styleRegular,      "Lung"))
        stream.paragraph(188f, y+86, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, "96.5%"))
        stream.paragraph(293f, y+86, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, "73.1%"))
        stream.paragraph(392f, y+86, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, "12.7%"))
        stream.paragraph(498f, y+86, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, ">98%"))

        stream.paragraph( 88f, y+70, 100f, AlignHorizontal.CENTER, TextBlock(styleRegular,      "Colon"))
        stream.paragraph(188f, y+70, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, "96.5%"))
        stream.paragraph(293f, y+70, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, "70.1%"))
        stream.paragraph(392f, y+70, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, "17.8%"))
        stream.paragraph(498f, y+70, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, ">98%"))

        stream.paragraph( 88f, y+54, 100f, AlignHorizontal.CENTER, TextBlock(styleRegular,      "Liver"))
        stream.paragraph(188f, y+54, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, "96.5%"))
        stream.paragraph(293f, y+54, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, "94.5%"))
        stream.paragraph(392f, y+54, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, "9.8%"))
        stream.paragraph(498f, y+54, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, ">98%"))

        stream.paragraph( 88f,  y+38, 100f, AlignHorizontal.CENTER, TextBlock(styleRegular,      "Pancreatobiliary"))
        stream.paragraph(188f, y+38, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, "96.5%"))
        stream.paragraph(293f, y+38, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, "91.3%"))
        stream.paragraph(392f, y+38, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, "6.8%"))
        stream.paragraph(498f, y+38, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, ">98%"))

        stream.paragraph( 88f, y+22, 100f, AlignHorizontal.CENTER, TextBlock(styleRegular,      "Esophageal"))
        stream.paragraph(188f, y+22, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, "96.5%"))
        stream.paragraph(293f, y+22, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, "88.4%"))
        stream.paragraph(392f, y+22, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, "2.0%"))
        stream.paragraph(498f, y+22, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, ">98%"))

        stream.paragraph( 88f, y+6, 100f, AlignHorizontal.CENTER, TextBlock(styleRegular,      "Ovarian"))
        stream.paragraph(188f, y+6, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, "96.5%"))
        stream.paragraph(293f, y+6, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, "70.4%"))
        stream.paragraph(392f, y+6, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, "1.7%"))
        stream.paragraph(498f, y+6, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, ">98%"))
        ...
        stream.paragraph(77f, y, 600f, AlignHorizontal.LEFT,
            TextBlock(template.resource().styleContentRegualar().clone().color(Color(151,151,151)).fontSize(6.5f), "※This test has not established the clinical significance of its results, and there is still insufficient evidence for the utility of health-related actions based on it.\n" +
