...
class SectionLimitation(private var y: Float = 755f) : Painter<CancerchTemplate<CancerchResource>, CancerchDto> {
    override fun paint(
        ...
        stream.paragraph(293f, y+102, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, template.lblLimitationTableTotalCancer(2)))
        stream.paragraph(392f, y+102, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, template.lblLimitationTableTotalCancer(3)))
        stream.paragraph(498f, y+102, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, template.lblLimitationTableTotalCancer(4)))

        stream.paragraph(88f, y+86, 100f, AlignHorizontal.CENTER, TextBlock(styleRegular,      template.lblLimitationTableLungCancer(0)))
        stream.paragraph(188f, y+86, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, template.lblLimitationTableLungCancer(1)))
        stream.paragraph(293f, y+86, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, template.lblLimitationTableLungCancer(2)))
        stream.paragraph(392f, y+86, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, template.lblLimitationTableLungCancer(3)))
        stream.paragraph(498f, y+86, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, template.lblLimitationTableLungCancer(4)))

        stream.paragraph(88f, y+70, 100f, AlignHorizontal.CENTER, TextBlock(styleRegular,      template.lblLimitationTableColorCancer(0)))
        stream.paragraph(188f, y+70, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, template.lblLimitationTableColorCancer(1)))
        stream.paragraph(293f, y+70, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, template.lblLimitationTableColorCancer(2)))
        stream.paragraph(392f, y+70, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, template.lblLimitationTableColorCancer(3)))
        stream.paragraph(498f, y+70, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, template.lblLimitationTableColorCancer(4)))

        stream.paragraph(88f, y+54, 100f, AlignHorizontal.CENTER, TextBlock(styleRegular,      template.lblLimitationTableLiverCancer(0)))
        stream.paragraph(188f, y+54, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, template.lblLimitationTableLiverCancer(1)))
        stream.paragraph(293f, y+54, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, template.lblLimitationTableLiverCancer(2)))
        stream.paragraph(392f, y+54, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, template.lblLimitationTableLiverCancer(3)))
        stream.paragraph(498f, y+54, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, template.lblLimitationTableLiverCancer(4)))

        stream.paragraph(88f,  y+38, 100f, AlignHorizontal.CENTER, TextBlock(styleRegular,      template.lblLimitationTablePanCancer(0)))
        stream.paragraph(188f, y+38, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, template.lblLimitationTablePanCancer(1)))
        stream.paragraph(293f, y+38, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, template.lblLimitationTablePanCancer(2)))
        stream.paragraph(392f, y+38, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, template.lblLimitationTablePanCancer(3)))
        stream.paragraph(498f, y+38, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, template.lblLimitationTablePanCancer(4)))

        stream.paragraph(88f, y+22, 100f, AlignHorizontal.CENTER, TextBlock(styleRegular,      template.lblLimitationTableEsopCancer(0)))
        stream.paragraph(188f, y+22, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, template.lblLimitationTableEsopCancer(1)))
        stream.paragraph(293f, y+22, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, template.lblLimitationTableEsopCancer(2)))
        stream.paragraph(392f, y+22, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, template.lblLimitationTableEsopCancer(3)))
        stream.paragraph(498f, y+22, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, template.lblLimitationTableEsopCancer(4)))

        stream.paragraph(88f, y+6, 100f, AlignHorizontal.CENTER, TextBlock(styleRegular,      template.lblLimitationTableOverCancer(0)))
        stream.paragraph(188f, y+6, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, template.lblLimitationTableOverCancer(1)))
        stream.paragraph(293f, y+6, 100f, AlignHorizontal.CENTER, TextBlock(styleRegularInner, template.lblLimitationTableOverCancer(2)))
