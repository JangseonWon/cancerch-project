...
interface CancerchTemplate<R: CancerchResource>: AbstractReportTemplate<R> {
    ...
    fun lblOverviewMidHighEnd(risk: CancerchDto.Results): String

    fun lblDoubtSquareTitle(): String
    fun lblDoubtSquareContent(result: CancerchDto.Results): String
    fun lblDoubtContentTitle(): String
    fun lblDoubtContentLarge(result: CancerchDto.Results, name: String): String
    fun lblDoubtContentSmall(result: CancerchDto.Results): String
    ...
    fun lblDetailResultAnalysisContentLine1Risk(result: CancerchDto.Results): String
    fun lblDetailResultAnalysisContentLine2NRM(): String
    fun lblDetailResultAnalysisContentLine3NRMLast() : String
    ...
    fun lblGuideLineHeader(type: CancerchDto.Results, name: String): String
    fun lblGuideLineTop(type: CancerchDto.Results, cancer: String): String
    ...
    fun lblGuideLineConcern(): String
