...
class GangbukSectionGuideLineKoKr(private var y: Float = 310f) : Painter<CancerchTemplate<CancerchResource>, CancerchDto> {
    override fun paint(
        ...
        if(dto.result != CancerchDto.Results.GENERAL) {
            ...
            stream.paragraph(60f, y+ RESULT_CONTENT_LOW_RATE -32, 100f, AlignHorizontal.CENTER, TextBlock(styleRegular, "폐암"))
            stream.paragraph(60f, y+ RESULT_CONTENT_LOW_RATE -61, 100f, AlignHorizontal.CENTER, TextBlock(styleRegular, "대장암"))
            stream.paragraph(60f, y+ RESULT_CONTENT_LOW_RATE -95, 100f, AlignHorizontal.CENTER, TextBlock(styleRegular, "간암"))
            stream.paragraph(60f, y+ RESULT_CONTENT_LOW_RATE -129, 100f, AlignHorizontal.CENTER, TextBlock(styleRegular, "췌장담도암"))
            stream.paragraph(60f, y+ RESULT_CONTENT_LOW_RATE -158, 100f, AlignHorizontal.CENTER, TextBlock(styleRegular, "식도암"))
            stream.paragraph(60f, y+ RESULT_CONTENT_LOW_RATE -182, 100f, AlignHorizontal.CENTER, TextBlock(styleRegular, "난소암"))

            stream.paragraph(97f, y+ RESULT_CONTENT_LOW_RATE -29, 200f, AlignHorizontal.LEFT, AlignVertical.MIDDLE, TextBlock(styleRegular, "만 54세 이상 만 74세 이하 남녀\n 폐암 발생 고위험군(30갑년*이상 흡연력)"))
            stream.paragraph(97f, y+ RESULT_CONTENT_LOW_RATE -59, 200f, AlignHorizontal.LEFT, AlignVertical.MIDDLE, TextBlock(styleRegular, "만 50세 이상 남녀"))
            stream.paragraph(97f, y+ RESULT_CONTENT_LOW_RATE -93,  200f, AlignHorizontal.LEFT, AlignVertical.MIDDLE, TextBlock(styleRegular, "만 40세 이상 남녀 중 간암 발생 고위험군\n"), TextBlock(styleRegular.clone().fontSize(7f), "(간경변증이나 B형 간염 바이러스 항원 또는\nC형 간염 바이러스 항체 양성으로 확인된 자)"))
            stream.paragraph(97f, y+ RESULT_CONTENT_LOW_RATE -127, 200f, AlignHorizontal.LEFT, AlignVertical.MIDDLE, TextBlock(styleRegular.clone().fontSize(7f), "만 70세 이상 남녀\n췌장담도암 가족력/장기 흡연자/만성췌장염 병력"))
            ...
            stream.paragraph(97f, y+ RESULT_CONTENT_LOW_RATE -180, 200f, AlignHorizontal.LEFT, AlignVertical.MIDDLE, TextBlock(styleRegular, "-"))

            stream.paragraph(295f, y+ RESULT_CONTENT_LOW_RATE -32, 100f, AlignHorizontal.CENTER, TextBlock(styleRegular, "2년"))
            stream.paragraph(295f, y+ RESULT_CONTENT_LOW_RATE -61, 100f, AlignHorizontal.CENTER, TextBlock(styleRegular, "1년"))
            stream.paragraph(295f, y+ RESULT_CONTENT_LOW_RATE -96,  100f, AlignHorizontal.CENTER, TextBlock(styleRegular, "6개월"))
            stream.paragraph(295f, y+ RESULT_CONTENT_LOW_RATE -129, 100f, AlignHorizontal.CENTER, TextBlock(styleRegular, "1년"))
            ...
            stream.paragraph(295f, y+ RESULT_CONTENT_LOW_RATE -182, 100f, AlignHorizontal.CENTER, TextBlock(styleRegular, "-"))

            stream.paragraph(343f, y+ RESULT_CONTENT_LOW_RATE -29, 100f, AlignHorizontal.LEFT, AlignVertical.MIDDLE,  TextBlock(styleRegular, "저선량흉부CT검사"))
            stream.paragraph(343f, y+ RESULT_CONTENT_LOW_RATE -59, 200f, AlignHorizontal.LEFT, AlignVertical.MIDDLE,  TextBlock(styleRegular, "분변잠혈검사 이상소견 시, 대장내시경검사\n"), TextBlock(styleRegular.clone().fontSize(6.5f), "(단, 대장내시경을 실시하기 어려운 경우 대장이중조영검사 선택적 시행)"))
            stream.paragraph(343f, y+ RESULT_CONTENT_LOW_RATE -93,  200f, AlignHorizontal.LEFT, AlignVertical.MIDDLE, TextBlock(styleRegular,"간초음파검사, 혈청알파태아단백검사"))
            stream.paragraph(343f, y+ RESULT_CONTENT_LOW_RATE -127, 100f, AlignHorizontal.LEFT, AlignVertical.MIDDLE, TextBlock(styleRegular, "복부초음파검사, 복부CT검사"))
            ...
            stream.paragraph(343f, y+ RESULT_CONTENT_LOW_RATE -180, 230f, AlignHorizontal.LEFT, AlignVertical.MIDDLE, TextBlock(styleRegular.clone().fontSize(7.5f), "CA125 암표지자 검사 이상소견 시 초음파검사, CT검사, MRI검사"))
