...
class GangbukSectionIntroKoKr(private val y: Float = 685f): Painter<CancerchTemplate<CancerchResource>, CancerchDto> {
    override fun paint(
        ...
        stream.paragraph(51f, y-32, 500f, AlignHorizontal.LEFT, TextBlock(template.resource().styleContentRegualar().clone().fontSize(9f),
            "종양 DNA 혈액검사는 약 5,000명의 암 환자 및 건강인에서 특징적으로 나타나는 DNA 패턴을 학습한 인공지능으로 수검자의 DNA\n" +
