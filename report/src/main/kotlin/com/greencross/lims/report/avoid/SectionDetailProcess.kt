...
class SectionDetailProcess (private var y: Float = 685f)  : Painter<AvoidTemplate<AvoidResource>, AvoidDto> {
    override fun paint(
        ...
        stream.paragraph(513f, y+height-80, 100f, AlignHorizontal.LEFT, TextBlock(styleRegular.clone().color(Color(131, 131, 131)), template.lblDetailProcessContentCode(6)))
        stream.paragraph(513f, y+height-103, 100f, AlignHorizontal.LEFT, TextBlock(styleBold.clone().fontSize(11f), template.lblDetailProcessContentCode(7)))
        stream.paragraph(513f, y+height-125, 100f, AlignHorizontal.LEFT, TextBlock(styleRegular.clone().color(Color(131, 131, 131)), template.lblDetailProcessContentCode(8)))
        stream.paragraph(513f, y+height-148, 100f, AlignHorizontal.LEFT, TextBlock(styleRegular.clone().color(Color(131, 131, 131)), template.lblDetailProcessContentCode(9)))
