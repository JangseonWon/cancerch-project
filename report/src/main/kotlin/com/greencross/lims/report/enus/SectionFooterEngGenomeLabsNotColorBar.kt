...
class SectionFooterEngGenomeLabsNotColorBar<T: Template<out HasSign>, D: AbstractReportDto> : Painter<T, D> {
    ...
    override fun paint(
        ...
        if (img == null) {
            val src: BufferedImage = ImageIO.read(File(resource, "/img/footerLabsGenomeEnUs.png"))
