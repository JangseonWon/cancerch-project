...
class GangbukSectionSimpleTitleKoKr(private val y: Float = 805f) : Painter<CancerchTemplate<CancerchResource>, CancerchDto> {
    override fun paint(
        ...
        stream.line(56f, y+6, 56f, y-1).setLineDashPattern(floatArrayOf(0f, 0f), 0f).setLineWidth(0.7f).setStrokingColor(
            Color(81, 78, 145)
        ).stroke()
        ...
        stream.line(366f, y+6, 366f, y-1).setLineDashPattern(floatArrayOf(0f, 0f), 0f).setLineWidth(0.7f).setStrokingColor(
            Color(81, 78, 145)
        ).stroke()
        ...
        stream.line(511f, y+6, 511f, y-1).setLineDashPattern(floatArrayOf(0f, 0f), 0f).setLineWidth(0.7f).setStrokingColor(
            Color(81, 78, 145)
        ).stroke()
