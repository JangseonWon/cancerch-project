...
class SectionDisclaimers(private val y: Float = 708f): Painter<DNACXTemplate<DNACXResource>, DNACXDto> {
    override fun paint(
        ...
        stream.paragraph(35f, y-14f, 400f, AlignHorizontal.LEFT, TextBlock(template!!.resource().styleContentBold().clone().color(Color(67,72,142)).fontSize(15f), "検査限界"))
        ...
        stream.paragraph(75f, y-245f, 495f, AlignHorizontal.LEFT, TextBlock(style, "このテストは、結果の臨床的意義を確立しておらず、この結果に基づく治療関連の行動の有用性についての証拠\n" +
