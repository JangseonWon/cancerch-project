...
import com.greencross.lims.report.builder.Util.Companion
...
open class Util_EnUS {
    companion object {
        ...
        fun getDynamicFontSize(maxSize: Float = 10f, minSize: Float = 1f, textLength: Int, maxLength: Int = 9999): Float {
