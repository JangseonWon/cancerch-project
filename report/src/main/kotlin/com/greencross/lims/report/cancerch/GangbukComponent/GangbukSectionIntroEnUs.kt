...
class GangbukSectionIntroEnUs(private val y: Float = 685f): Painter<CancerchTemplate<CancerchResource>, CancerchDto> {
    override fun paint(
        ...
        stream.paragraph(48f, y-29, 500f, AlignHorizontal.LEFT, TextBlock(template.resource().styleContentRegualar().clone().fontSize(7f),
            "Circulating tumor DNA test is the multi cancer early detection(MCED) test powered by artificial intelligence(AI) that has trained distinctive DNA patterns from\n" +
                "approximately 5,000 cancer patients and healthy individuals. It analyzes DNA patterns to predict the likelihood of the 6 major types of cancers. The test results\n" +
                "indicate the potential presence of circulating tumor DNA and require further diagnostic confirmations."))
