...
class SectionDisclaimers(private val y: Float = 708f): Painter<DNACTTemplate<DNACTResource>, DNACTDto> {
    override fun paint(
        ...
        stream.paragraph(35f, y - 14f, 400f, AlignHorizontal.LEFT, TextBlock(template!!.resource().styleContentBold().clone().color(Color(0,80,109)).fontSize(15f), "Disclaimers"))
        stream.circle(36f, y - 34f, 1.5f).fill()
        stream.paragraph(42f, y - 38f, 700f, AlignHorizontal.LEFT, TextBlock(style, "This test analyzes cfDNA patterns to screen for cancer, but a cancer signal does not necessarily indicate\na cancer diagnosis"))
        ...
        stream.paragraph(
            75f, y - 245f, 495f, AlignHorizontal.LEFT, TextBlock(
                style,
                "This test has not established the clinical significance of its results, and there is still insufficient evidence for the utility of\n" +
