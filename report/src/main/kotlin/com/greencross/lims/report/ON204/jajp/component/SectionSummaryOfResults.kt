...
class SectionSummaryOfResults(private val y: Float = 533f): Painter<DNACXTemplate<DNACXResource>, DNACXDto> {
    override fun paint(
        ...
        stream.paragraph(35f, y-14f, 400f, AlignHorizontal.LEFT, TextBlock(template!!.resource().styleContentBold().clone().color(Color(67,72,142)).fontSize(15f), "結果の概要"))
        ...
        stream.paragraph(193f, y-44f, 200f, AlignHorizontal.CENTER, TextBlock(tableHeaderFont, "腫瘍シグナルの確率\n"))
        stream.paragraph( 87f, y-65f, 200f, AlignHorizontal.CENTER, TextBlock(tableHeaderFont, "シグナルスコア"))
        stream.paragraph(192f, y-65f, 200f, AlignHorizontal.CENTER, TextBlock(tableHeaderFont, "COVスコア"))
        stream.paragraph(298f, y-65f, 200f, AlignHorizontal.CENTER, TextBlock(tableHeaderFont, "FEMSスコア"))
        stream.paragraph(403f, y-55f, 200f, AlignHorizontal.CENTER, TextBlock(tableHeaderFont, "cfDNA濃度"))
        stream.paragraph(508f, y-47f, 200f, AlignHorizontal.CENTER, TextBlock(tableHeaderFont, "ゲノム不安定性\n(i-score)"))
